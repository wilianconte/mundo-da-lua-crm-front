  ...
  return (
    <Card className="border-[var(--color-primary-soft)] bg-[var(--color-primary-soft)]/40">
      <CardContent className="grid gap-3 p-4 sm:grid-cols-2 xl:grid-cols-4">
        <div>
          <p className="text-xs uppercase tracking-[0.18em] text-[var(--color-muted-foreground)]">Full name</p>
          <p className="mt-1 text-sm font-semibold text-[var(--color-foreground)]">{person.fullName}</p>
        </div>
        <div>
          <p className="text-xs uppercase tracking-[0.18em] text-[var(--color-muted-foreground)]">Document</p>
